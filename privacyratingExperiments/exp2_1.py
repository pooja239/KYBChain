...
dp_p_pref_price_w_LCD = price_min_LCD + (50*(price_max_LCD-price_min_LCD)/100)
dp_p_pref_price_wo_HCD = price_min_HCD + (70*(price_max_HCD-price_min_HCD)/100)
dp_p_pref_price_w_HCD = price_min_HCD + (70*(price_max_HCD-price_min_HCD)/100)

dp_f_pref_price_wo_LCD = price_min_LCD + (60*(price_max_LCD-price_min_LCD)/100)
dp_f_pref_price_w_LCD = price_min_LCD + (60*(price_max_LCD-price_min_LCD)/100)
dp_f_pref_price_wo_HCD = price_min_HCD + (80*(price_max_HCD-price_min_HCD)/100)
dp_f_pref_price_w_HCD = price_min_HCD + (80*(price_max_HCD-price_min_HCD)/100)
