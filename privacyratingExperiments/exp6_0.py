...
dp_p_pref_price_wo_LCD = 0
dp_p_pref_price_w_LCD = 0
dp_p_pref_price_wo_HCD = 0
dp_p_pref_price_w_HCD = 0

dp_f_pref_price_wo_LCD = 0
dp_f_pref_price_w_LCD = 0
dp_f_pref_price_wo_HCD =0
dp_f_pref_price_w_HCD = 0
...
pref_dp_p = {'w': [1/3, 1/3, 1/3], 'alpha': [0.1, 0.7, 0.2], 'WoRate_LCD': [0, 0, 0, 0, dp_p_pref_price_wo_LCD], 'WoRate_HCD': [0, 0, 0, 0, dp_p_pref_price_wo_HCD], 'WRate_LCD': [0.5, 0, 0, 0, dp_p_pref_price_w_LCD], 'WRate_HCD': [0.7, 0, 0, 0, dp_p_pref_price_w_HCD]}

pref_dp_f = {'w': [1/3, 1/3, 1/3], 'alpha': [0.1, 0.7, 0.2], 'WoRate_LCD': [0, 0.6, 0, 0, dp_f_pref_price_wo_LCD], 'WoRate_HCD': [0, 0.8, 0, 0, dp_f_pref_price_wo_HCD], 'WRate_LCD': [0, 0.6, 0.6, 0.6, dp_f_pref_price_w_LCD], 'WRate_HCD': [0, 0.8, 0.8, 0.8, dp_p_pref_price_w_HCD]}
