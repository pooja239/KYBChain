 ...
 */
class registerBuyer extends OperationBase {
    ...
    async submitTransaction() {
        ...
        let registerBuyerArgs = this.simpleState.getregisterBuyer();
        await this.sutAdapter.sendRequests(this.createConnectorRequest('registerUser', registerBuyerArgs));
    }
}
