 ...
 */
class confirmDelivery extends OperationBase {
    ...
    async submitTransaction() {
        ...
        let confirmDeliveryArgs = this.simpleState.getconfirmDelivery(this.index);
        await this.sutAdapter.sendRequests(this.createConnectorRequest('confirmDelivery_wo', confirmDeliveryArgs));
    }
}
