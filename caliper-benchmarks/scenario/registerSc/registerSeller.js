 ...
 */
class registerSeller extends OperationBase {
    ...
    async submitTransaction() {
        ...
        let registerUserArgs = this.simpleState.getregisterSeller();
        //console.log(">>>>>>>>>>>>>>> arguments" + registerUserArgs.username + "   " + registerUserArgs._role + "    " + registerUserArgs._balance)
        await this.sutAdapter.sendRequests(this.createConnectorRequest('registerUser', registerUserArgs));
    }
}
