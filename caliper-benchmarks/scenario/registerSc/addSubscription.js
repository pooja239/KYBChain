 ...
 */
class addSubscription extends OperationBase {
    ...
    async submitTransaction() {
        ...
        let addSubscriptionArgs = this.simpleState.getaddSubscription(this.index);
        await this.sutAdapter.sendRequests(this.createConnectorRequest('addSubscription', addSubscriptionArgs));
    }
}
