 ...
 */
class updateProfile extends OperationBase {
     ...
     */
    createSimpleState() {
        return new SimpleState(this.workerIndex, this.subscriptionsperbuyer);
    }
    ...
    async submitTransaction() {
        ...
        let updateProfileArgs = this.simpleState.getupdateProfile();
        await this.sutAdapter.sendRequests(this.createConnectorRequest('updatePurchase', updateProfileArgs));
    }
}
