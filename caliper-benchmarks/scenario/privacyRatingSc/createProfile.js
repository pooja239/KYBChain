 ...
 */
class createProfile extends OperationBase {
    ...
    async submitTransaction() {
        ...
        let createProfileArgs = this.simpleState.getcreateProfile();
        await this.sutAdapter.sendRequests(this.createConnectorRequest('createProfile', createProfileArgs));
    }
}
