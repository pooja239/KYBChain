 ...
 */
class initialize extends OperationBase {
    ...
    async submitTransaction() {
        ...
        let initArgs = this.simpleState.getinitaddress();
        await this.sutAdapter.sendRequests(this.createConnectorRequest('initialize', initArgs));
    }
}
