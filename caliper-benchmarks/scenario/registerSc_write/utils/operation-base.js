...
class OperationBase extends WorkloadModuleBase {
    ...
    async initializeWorkloadModule(workerIndex, totalWorkers, roundIndex, roundArguments, sutAdapter, sutContext) {
        ...
        this.assertSetting('privacyRatingSc');
        this.assertSetting('numberOfAgreements');
        this.privacyRatingSc = this.roundArguments.privacyRatingSc;
        this.numberOfAgreements = this.roundArguments.numberOfAgreements;
        this.index = this.roundArguments.index;
    ...
    _createEthereumConnectorRequest(operation, args) {
        const query = operation === 'retrieveProfiles';
        //console.log(">>>>>>>>>>>>>>> " + operation);
        //console.log(">>>>>>>>>>>>>>> " + Object.keys(args).map(k => args[k]));
        return {
            contract: 'registerSc',
            verb: operation,
